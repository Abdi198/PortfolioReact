                ...
                <div className="timeline-centered">
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Bootcamp <span>2020</span></h2>
                        <p>Recent bootcamp graduate, currently employed as Help Desk Analyst M Health Fairview. Seeking front-end and back-end web development opportunities. I love technology and I am passionate about learning new ones and staying current. </p>
                      </div>
                    </div>
                  </article>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Grossmont College <span>2012-2015</span></h2>
                        <p>Associates in Communications of Arts.</p> 
                      </div>
                    </div>
                  </article>
